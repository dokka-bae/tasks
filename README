...
## task_6
Прогнозирование временного ряда. За датасет я взял данные с биржи. Для прогнозирования написал нейронку с LTSM и CNN слоями. Пока что MAE ошибка 0.0035. Пока что я еще пробую различные варианты как архитектуры сетки, так и самих данных. Главная задача - предсказать цену закрытия следующего бара-свечки на основе последней N последовательности.
PS. 
